    ...
    <div className="space-y-6 md:space-y-8">
      ...
      {hasCompletedForm && (
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
          <h2 className="text-lg md:text-xl font-semibold text-gray-900 mb-4 md:mb-6">Estado del Proceso</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              <div className="flex items-center mb-2 md:mb-4">
                ...
                <h3 className="font-medium text-blue-900 text-sm md:text-base">Información del Caso</h3>
              </div>
            ...
            <div className="bg-yellow-50 rounded-lg p-4">
              <div className="flex items-center mb-2 md:mb-4">
                ...
                <h3 className="font-medium text-yellow-900 text-sm md:text-base">Estado Actual</h3>
              </div>
            ...
            <div className="bg-green-50 rounded-lg p-4">
              <div className="flex items-center mb-2 md:mb-4">
                ...
                <h3 className="font-medium text-green-900 text-sm md:text-base">Etapa Proceso</h3>
              </div>
              <div className="space-y-2">
                <p className="text-xs md:text-sm text-gray-600">
                  Completados:
      ...
      <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
        <h2 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Próximos Pasos</h2>
      ...
      <div className="bg-white rounded-lg shadow-md p-4 md:p-6 space-y-4">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 md:mb-6">
          <h2 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 sm:mb-0">Ofertas de Trabajo</h2>
        ...
        {isJobSearching && (
          <>
            {jobOffers.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                {jobOffers.map((offer) => (
                  <div key={offer.id} className="bg-gray-100 rounded-lg p-4">
                    ...
                    <p className="text-xs md:text-sm text-gray-600">Pago por hora: {offer.hourly_pay}</p>
                    <p className="text-xs md:text-sm text-gray-600">Ciudad: {offer.city}</p>
                    <p className="text-xs md:text-sm text-gray-600 mb-2">Beneficios: {offer.benefits}</p>
                    <a
                      href={offer.whatsapp_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-4 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded inline-block text-sm"
                    >
              ...
              <p className="text-gray-600 text-sm md:text-base">No hay ofertas de trabajo disponibles en este momento.</p>
            )}
