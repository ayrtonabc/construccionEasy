...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 md:ml-4">
              <p className="text-xs md:text-sm font-medium text-gray-500">Total Clientes</p>
              <p className="text-xl md:text-2xl font-semibold text-gray-900">{stats.totalClients}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 md:ml-4">
              <p className="text-xs md:text-sm font-medium text-gray-500">Procesos Activos</p>
              <p className="text-xl md:text-2xl font-semibold text-gray-900">{stats.activeProcesses}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 md:ml-4">
              <p className="text-xs md:text-sm font-medium text-gray-500">Docs. Pendientes</p>
              <p className="text-xl md:text-2xl font-semibold text-gray-900">{stats.pendingDocuments}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 md:ml-4">
              <p className="text-xs md:text-sm font-medium text-gray-500">Tareas Pendientes</p> {/* Changed label */}
              <p className="text-xl md:text-2xl font-semibold text-gray-900">{stats.urgentCases}</p> {/* Stat now reflects pending tasks */}
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-4 max-h-96 overflow-y-auto">
              {recentActivity.map((activity) => (
                <div key={activity.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b pb-4">
                  ...
                  <span className="text-sm text-gray-400 whitespace-nowrap ml-0 sm:ml-2">{activity.time}</span>
                </div>
              ))}
            </div>
          ) : (
      ...
      <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
          <h2 className="text-lg font-semibold text-gray-900 mb-2 sm:mb-0">Tareas Administrativas</h2>
          <button
            onClick={() => {
              setEditingTask(null);
              setNewTaskDescription('');
            ...
            className="bg-blue-500 text-white py-1 px-3 rounded flex items-center text-sm hover:bg-blue-600 w-full sm:w-auto justify-center"
          >
          ...
          {loadingTasks ? (
            ...
            getFilteredTasks(pendingTasks).length > 0 ? (
              getFilteredTasks(pendingTasks).map((task) => (
                <div key={task.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-gray-50 p-3 rounded-lg border">
            ...
            getFilteredTasks(completedTasks).length > 0 ? (
              getFilteredTasks(completedTasks).map((task) => (
                <div key={task.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-green-50 p-3 rounded-lg border border-green-200 opacity-80">
                  <div className="flex-1 mr-0 sm:mr-4 mb-2 sm:mb-0">
                  ...
                  <button
                    ...
                    className="bg-yellow-100 text-yellow-700 p-1 rounded-full hover:bg-yellow-200 self-end sm:self-center"
